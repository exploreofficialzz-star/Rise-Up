...
// Production-ready — real API wiring, ad placements, error handling, search
...
/// Splits an emoji-label topic string: '💰 Wealth' → ('💰', 'Wealth')
...
class _GroupsScreenState extends State<GroupsScreen>
  ...
  // Interleave ad-slot sentinels into a real item list
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
            ...
            child: _loading
                ...
                : _hasError
                    ...
                    : TabBarView(
                        ...
                        children: [
                          _buildMyGroupsTab(
                            isDark, textColor, subColor, cardColor, borderColor, surfaceColor,
                          ),
                          _buildDiscoverTab(
                            isDark, textColor, subColor, cardColor, borderColor, surfaceColor,
                          ),
          ...
          // ── Sticky bottom banner (hidden for premium users) ────
            ...
            child: Padding(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  prefixIcon: Icon(Iconsax.search_normal_1, size: 18, color: subColor),
                  ...
                  if (_searchQuery.isNotEmpty) ...[
                    ...
                    GestureDetector(
                      onTap: () => _showCreateGroupSheet(
                        context, isDark, isDark ? AppColors.bgSurface : Colors.grey.shade100,
                        isDark ? AppColors.bgSurface : Colors.grey.shade200, textColor, subColor,
                      ),
                      child: Container(
          ...
          return Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Build a community around your wealth niche',
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        TextField(
                          ...
                          style: TextStyle(fontSize: 14, color: textColor),
                          decoration: InputDecoration(
                            hintText: 'What is this group about? Who should join?',
                            hintStyle: TextStyle(color: subColor, fontSize: 13),
                            filled: true,
                            fillColor: surfaceColor,
                            border: OutlineInputBorder(
                        ...
                        // Topic chips
                        _SheetLabel(label: 'Topic / Category *', subColor: subColor),
                        ...
                        Wrap(
                          ...
                          children: _kAllTopics.map((topic) {
                            ...
                            return GestureDetector(
                              onTap: () => setSt(() => selectedTopic = topic),
                ...
                GestureDetector(
                  onTap: creating
                      ...
                      : () async {
                          ...
                          setSt(() => creating = true);
                          try {
                            final (emoji, label) = _splitTopic(selectedTopic);
                            ...
                            if (ctx.mounted) {
                              Navigator.pop(ctx);
                              _load();
                              _showSuccessSnack('$emoji Group "$name" created!');
                            }
                          } catch (e) {
                  ...
                  child: AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      ...
                      color: creating ? AppColors.primary.withOpacity(0.45) : null,
...
// ─────────────────────────────────────────────────────────────────────────────
// Small helper widget for sheet section labels
// ─────────────────────────────────────────────────────────────────────────────
class _SheetLabel extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Text(
        label,
        style: TextStyle(fontSize: 13, fontWeight: FontWeight.w500, color: subColor),
      );
}

// ─────────────────────────────────────────────────────────────────────────────
// _GroupCard — reusable group list item
// ─────────────────────────────────────────────────────────────────────────────
