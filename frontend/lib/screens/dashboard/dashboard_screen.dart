                  ...
                  children: [
                    if (_loading)
                      ...
                      GridView.count(
                        ...
                        children: [
                          _FeatureTile(icon: Icons.auto_awesome_rounded, label: 'Agentic AI', sub: 'Execute any task', color: AppColors.accent, onTap: () => context.go('/agent'), isDark: isDark, badge: 'APEX'),
                          _FeatureTile(icon: Iconsax.flash, label: 'Workflows', sub: 'AI income plans', color: AppColors.success, onTap: () => context.go('/workflow'), isDark: isDark),
                          _FeatureTile(icon: Icons.trending_up_rounded, label: 'Market Pulse', sub: "What pays now", color: const Color(0xFFFF6B35), onTap: () => context.go('/pulse'), isDark: isDark, badge: 'LIVE'),
                          _FeatureTile(icon: Icons.emoji_events_rounded, label: 'Challenges', sub: '30-day sprints', color: const Color(0xFF6C5CE7), onTap: () => context.go('/challenges'), isDark: isDark),
                          _FeatureTile(icon: Iconsax.briefcase, label: 'Client CRM', sub: 'Track deals', color: AppColors.primary, onTap: () => context.go('/crm'), isDark: isDark),
                          _FeatureTile(icon: Iconsax.document_text, label: 'Contracts', sub: 'AI contracts', color: AppColors.gold, onTap: () => context.go('/contracts'), isDark: isDark),
                          _FeatureTile(icon: Iconsax.gallery, label: 'Portfolio', sub: 'Showcase work', color: const Color(0xFFFF3CAC), onTap: () => context.go('/portfolio'), isDark: isDark),
                          _FeatureTile(icon: Icons.psychology_rounded, label: 'Memory', sub: 'Income DNA', color: const Color(0xFF00B894), onTap: () => context.go('/memory'), isDark: isDark),
                        ],
          ...
          children: [
            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  _DSec('INCOME TOOLS'),
                  _DIt(Icons.auto_awesome_rounded, 'Agentic AI', 'Execute ANY income task', onTap: () { Navigator.pop(context); context.go('/agent'); }, badge: 'HEAVY', badgeColor: AppColors.accent),
                  _DIt(Iconsax.flash, 'Workflow Engine', 'AI income execution', onTap: () { Navigator.pop(context); context.go('/workflow'); }, badge: 'NEW', badgeColor: AppColors.success),
                  _DIt(Iconsax.chart_3, 'Market Pulse', 'What pays right now', onTap: () { Navigator.pop(context); context.go('/pulse'); }, badge: '🔥', badgeColor: const Color(0xFFFF6B35)),
                  _DIt(Icons.emoji_events_rounded, 'Challenges', '30-day income sprints', onTap: () { Navigator.pop(context); context.go('/challenges'); }),
                  _DIt(Iconsax.briefcase, 'Client CRM', 'Track clients & deals', onTap: () { Navigator.pop(context); context.go('/crm'); }),
                  _DIt(Iconsax.document_text, 'Contracts & Invoices', 'AI contract writing', onTap: () { Navigator.pop(context); context.go('/contracts'); }),
                  _DIt(Icons.psychology_rounded, 'Income Memory', 'Your income DNA', onTap: () { Navigator.pop(context); context.go('/memory'); }),
                  _DIt(Iconsax.gallery, 'Portfolio', 'Shareable showcase', onTap: () { Navigator.pop(context); context.go('/portfolio'); }),
                  ...
                  _DIt(Iconsax.people, 'Collaboration', 'Build together', onTap: () { Navigator.pop(context); context.go('/collaboration'); }, badge: 'NEW', badgeColor: AppColors.primary),
