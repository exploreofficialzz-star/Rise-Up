...
class _OnboardingChatScreenState extends State<OnboardingChatScreen> {
  ...
  Future<void> _send([String? text]) async {
    ...
    try {
      ...
      setState(() {
        _messages.add(_Message("I had trouble connecting. Please try again! 🔄", false));
        _loading = false;
      });
    }
  }
          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                Text('Your personal wealth mentor', style: AppTextStyles.caption),
              ],
            ),
          ],
        ),
      ...
      body: Column(
        children: [
          ...
          LinearProgressIndicator(
            value: _complete ? 1.0 : (_messages.length / 20.0).clamp(0, 0.95),
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (_, i) {
                ...
                final m = _messages[i];
                return _ChatBubble(message: m).animate().fadeIn(duration: 300.ms).slideY(begin: 0.2);
              },
            ),
          ),
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text('Profile complete! Preparing your roadmap...', style: AppTextStyles.body.copyWith(color: AppColors.success)),
                  ),
                ],
              ),
          ...
          // Input
          if (!_complete) _ChatInput(ctrl: _ctrl, onSend: _send, loading: _loading),
        ],
      ),
    );
  }
              ...
              child: message.isUser
                  ...
                  : MarkdownBody(
                      ...
                      styleSheet: MarkdownStyleSheet(
                        ...
                        strong: AppTextStyles.chatAI.copyWith(fontWeight: FontWeight.w700, color: AppColors.primary),
                        em: AppTextStyles.chatAI.copyWith(fontStyle: FontStyle.italic),
              ...
              children: List.generate(3, (i) => AnimatedBuilder(
                ...
                builder: (_, __) {
                  ...
                  return Container(
                    ...
                    width: 6, height: 6,
                    decoration: BoxDecoration(
                      color: AppColors.primary.withOpacity(0.4 + 0.6 * (phase < 0.5 ? phase * 2 : (1 - phase) * 2)),
      ...
      child: Wrap(
        ...
        children: replies.map((r) => GestureDetector(
          ...
          child: Container(
            ...
            child: Text(r, style: AppTextStyles.bodySmall.copyWith(color: AppColors.primaryLight)),
          ),
        )).toList(),
      ),
    );
...
class _ChatInput extends StatelessWidget {
  ...
  final bool loading;
  const _ChatInput({required this.ctrl, required this.onSend, required this.loading});
