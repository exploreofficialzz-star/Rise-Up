...
final _samplePosts = [
  PostModel(
    ...
    tag: '💰 Wealth',
    content:
        'Just closed my first \$5,000 freelance deal this month! The key was niching down and solving ONE specific problem for clients.\n\nStop trying to do everything. Pick one skill. Go deep.',
    likes: 247,
    comments: 38,
    shares: 12,
    verified: true,
  ...
  PostModel(
    ...
    tag: '⚡ Hustle',
    content:
        'Turned my graphic design hobby into \$3K/month in 6 months.\n\nMy strategy was dead simple:\n- Posted 1 design tip daily on LinkedIn\n- Reached out to 5 potential clients every day\n- Offered free work for testimonials first\n\nNow I have a waiting list. Your skill is worth more than you think.',
    likes: 673,
    comments: 91,
    shares: 55,
    verified: false,
...
class _HomeScreenState extends State<HomeScreen>
  ...
  // Called when user taps Ask AI or Chat Privately
  Future<void> _handleAiRequest(
    PostModel post, {
        ...
        body: TabBarView(
          ...
          children: List.generate(
              ...
              (_) => _FeedList(
                    ...
                    subColor: subColor,
                    onAskAI: (post) =>
                        _handleAiRequest(post, isPrivate: false),
                    onPrivateChat: (post) =>
                        _handleAiRequest(post, isPrivate: true),
